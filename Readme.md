...
# Parsing + Configuration Script – AgroSense Carbon dioxide (CO2) sensor - Rev. A

This **Parsing + Configuration** script is designed for the **AgroSense Carbon dioxide (CO2) sensor** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing + Configuration – AgroSense Carbon dioxide (CO2) sensor Rev. A

Este script de **Parsing + Configuration** está diseñado para el modelo **AgroSense Carbon dioxide (CO2) sensor** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
